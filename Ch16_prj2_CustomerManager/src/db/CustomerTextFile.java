...
public abstract class CustomerTextFile implements DAO<Customer> {
    ...
    public CustomerTextFile() throws DAOException {
    ...
    @Override
    public boolean add(Customer c)throws DAOException {
        customers.add(c);
        return this.saveAll();
    }

    @Override
    public boolean delete(Customer c)throws DAOException {
        customers.remove(c);
        return this.saveAll();
    }

    @Override
    public boolean update(Customer newCustomer) throws DAOException {
